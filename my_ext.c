...
static int le_my_ext;

/* {{{ PHP_INI
 */
/* Remove comments and fill if you need to have entries in php.ini
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("my_ext.global_value",      "42", PHP_INI_ALL, OnUpdateLong, global_value, zend_my_ext_globals, my_ext_globals)
    STD_PHP_INI_ENTRY("my_ext.global_string", "foobar", PHP_INI_ALL, OnUpdateString, global_string, zend_my_ext_globals, my_ext_globals)
PHP_INI_END()
*/
/* }}} */
...
/* {{{ proto string confirm_my_ext_compiled(string arg)
...
static void php_my_ext_init_globals(zend_my_ext_globals *my_ext_globals)
{
	my_ext_globals->global_value = 0;
	my_ext_globals->global_string = NULL;
}
*/
/* }}} */
...
{
#if defined(COMPILE_DL_MY_EXT) && defined(ZTS)
...
PHP_MINFO_FUNCTION(my_ext)
{
	...
	php_info_print_table_header(2, "my_ext support", "enabled");
...
/* {{{ my_ext_functions[]
 *
 * Every user visible function must have an entry in my_ext_functions[].
 */
